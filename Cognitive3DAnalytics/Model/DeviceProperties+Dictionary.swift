...
extension DeviceProperties {
    ...
    public func toDictionary() -> [String: Any] {
        let dict: [String: Any] = [
            ...
            CodingKeys.deviceHardwareMachine.rawValue: deviceHardwareMachine,
    ...
    public static func fromDictionary(_ dict: [String: Any]) -> DeviceProperties? {
        guard
            ...
            let deviceHardwareMachine = dict[CodingKeys.deviceHardwareMachine.rawValue] as? String,
        ...
        return DeviceProperties(
            ...
            deviceHardwareMachine: deviceHardwareMachine,
            deviceGPU: deviceGPU,
            deviceOS: deviceOS,
